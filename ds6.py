...
# para pegar o caminho do arquivo pra coloca no caminho certo
...
class Historico:
    ...
    # flitar todas as trasações do dia
    def transacoes_do_dia(self):
        data_atual = datetime.utcnow().date()
        transacoes = []
        # self._transacoes e da class
        for transacao in self._transacoes:
